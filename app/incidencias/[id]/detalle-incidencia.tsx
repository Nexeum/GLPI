...
import {AlertTriangle, CheckCircle, Clock, FileCode, FileText, Save} from "lucide-react"
import {actualizarIncidencia, Incidencia} from "@/lib/api/incidencias"
import {Comentario, crearComentario} from "@/lib/api/comentarios"
import {CountdownTimer} from "@/components/incidencias/countdown-timer"
import {MODULOS} from "@/lib/types/incidencias"
import {format} from "date-fns"
import {es} from "date-fns/locale"
import {type Etiqueta, Etiquetas} from "@/components/incidencias/etiquetas"
import {type CambioIncidencia, HistorialCambios} from "@/components/incidencias/historial-cambios"
...
import {Adjunto} from "@/lib/api/adjuntos";
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="md:col-span-2 space-y-6">
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <Label>Correo</Label>
                                                {editMode ? (
                                                    <Input name="correo" value={formData.correo || ""}
                                                           onChange={handleChange} className="mt-1"/>
                                                ) : (
                                    ...
                                    <div>
                                        ...
                                        {editMode ? (
                                            ...
                                            <div
                                                className="text-sm whitespace-pre-wrap border rounded-md p-3 bg-gray-50 dark:bg-gray-900">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                {editMode ? (
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value="Core de Rentas">Core de
                                                                Rentas</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                ) : (
                                            ...
                                            <div>
                                                ...
                                                {editMode ? (
                                                    <Input name="azure" value={formData.azure || ""}
                                                           onChange={handleChange} className="mt-1"/>
                                                ) : (
                                            ...
                                            <div>
                                                <Label>ID GLPI</Label>
                                                {editMode ? (
                                                    <Input name="glpi" value={formData.glpi || ""}
                                                           onChange={handleChange} className="mt-1"/>
                                                ) : (
                                                ...
                                                {editMode ? (
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            ...
                                                            <SelectItem
                                                                value="Devuelto/cancelado">Devuelto/cancelado</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                ) : (
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    {editMode ? (
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span
                                                                className="text-sm">{incidencia.asignado || "Sin asignar"}</span>
                                                        </div>
                                                    )}
                                                    <AsignacionAutomatica incidencia={incidencia}
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="p-0">
                                            <Timeline steps={getTimelineSteps() as any}/>
                                        </CardContent>
                                    </Card>
                                        ...
                                        <Card>
                                            ...
                                            <CardContent>
                                                <p className="text-sm text-muted-foreground">
                                                    Esta incidencia tiene un script asociado. Haga clic en "Ver Script"
                                                    para visualizarlo.
                                                </p>
                                            </CardContent>
                                        </Card>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {comentarios.length === 0 ? (
                                        <div className="text-center p-8 text-muted-foreground">No hay comentarios para
                                            esta incidencia</div>
                                    ) : (
                                                    ...
                                                    <div className="flex items-center justify-between mb-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div
                                                                    className="text-xs text-muted-foreground">{formatearFecha(comentario.fecha)}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div
                                                        className="text-sm whitespace-pre-wrap">{comentario.texto}</div>
                                                </div>
                                            ))}
                                        </div>
                                    )}
                                                ...
                                                <CardContent className="p-0">
                                                    <div
                                                        ...
                                                        <div className="flex items-center gap-2 truncate">
                                                            ...
                                                            <span
                                                                className="font-medium text-sm truncate">{adjunto.nombre}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <span
                                                                className="text-xs text-gray-500">{adjunto.tamano}</span>
                                                        </div>
                                                    </div>
